          ...
          <div className="bg-slate-800 text-slate-50 text-sm p-3 md:rounded shadow-lg flex justify-between">
            <div className="text-slate-500 inline-flex">
              <a
                ...
                rel="noreferrer"
              >
                Check<span className="hidden sm:inline"> my GitHub</span>
              </a>{' '}
              <span className="italic px-1.5">or</span>{' '}
              <a className="font-medium hover:underline text-emerald-400" href="https://www.linkedin.com/in/leandro-pereyra/" target="_blank" rel="noreferrer">
               my LinkedIn
              </a>
            </div>
