        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">
              <FormattedMessage id="wf.title" />
            </h2>
            <p className="text-xl text-gray-400">
              <FormattedMessage id="wf.sub" />
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              <h4 className="h4 mb-2">
                <FormattedMessage id="wf.plan" />
              </h4>
              <p className="text-lg text-gray-400 text-center">
                <FormattedMessage id="wf.planDesc" />
              </p>
            </div>
            ...
            >
              ...
              <h4 className="h4 mb-2">
                <FormattedMessage id="wf.design" />
              </h4>
              <p className="text-lg text-gray-400 text-center">
                <FormattedMessage id="wf.designDesc" />
              </p>
            </div>
            ...
            >
              ...
              <h4 className="h4 mb-2">
                <FormattedMessage id="wf.dev" />
              </h4>
              <p className="text-lg text-gray-400 text-center">
                <FormattedMessage id="wf.devDesc" />
              </p>
            </div>
            ...
            >
              ...
              <h4 className="h4 mb-2">
                <FormattedMessage id="wf.launch" />
              </h4>
              <p className="text-lg text-gray-400 text-center">
                <FormattedMessage id="wf.launchDesc" />
              </p>
            </div>
            ...
            >
              ...
              <h4 className="h4 mb-2">
                <FormattedMessage id="wf.pos" />
              </h4>
              <p className="text-lg text-gray-400 text-center">
                <FormattedMessage id="wf.posDesc" />
              </p>
            </div>
            ...
            >
              ...
              <h4 className="h4 mb-2">
                <FormattedMessage id="wf.feed" />
              </h4>
              <p className="text-lg text-gray-400 text-center">
                <FormattedMessage id="wf.feedDesc" />
              </p>
            </div>
          </div>
        </div>
